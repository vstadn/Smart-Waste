''' Vitalii Stadnyk
    ...
    Software for the web server receiving information from the Arduino and saving data to the database
    April 25th, 2018 
'''
...
def data():
    ...
    cursor.execute("Insert into readings(data, time) values(%d, '%s')" % (data_value["Data"], format_date(datetime.now(timezone('US/Eastern')))))
    conn.commit()
